...
- **Vercel** (Recommended): See [VERCEL_DEPLOYMENT.md](./VERCEL_DEPLOYMENT.md) - FREE frontend + serverless backend
- **Railway**: See [DEPLOYMENT.md](./DEPLOYMENT.md) - Traditional deployment guide
