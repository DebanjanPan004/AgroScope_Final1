...
router.post('/chat', async (req, res) => {
  const { messages, wasteType, quantityTons, city, currentPrice, livePricePerKg, liveTrend, selectedLanguage, mode, systemPrompt: agroGuideSystemPrompt, pageContext } = req.body || {};
